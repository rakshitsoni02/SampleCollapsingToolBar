...
# EasyAdapter rules
-keepclassmembers class * extends rakshit.easyadapter.ItemViewHolder {
    public <init>(...);
 }
...
-keepclassmembers class samplefloat.data.model.** {
...
-keepclassmembers class samplefloat.data.remote.RibotsService$** {
    !static !private <fields>;
}
